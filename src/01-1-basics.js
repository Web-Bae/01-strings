...
function gradeCommentary() {
  ...
  if (studentGrade >= 80 && studentGrade <= 89) console.log("Good job!");
  // 3. If studentGrade is between 70 and 79 (inclusive), log "You passed.".
  if (studentGrade >= 70 && studentGrade <= 79) console.log("You passed.");
  // 4. If studentGrade is below 70, log "Needs improvement.".
  if (studentGrade < 70) console.log("Needs improvement.");
}
...
function calculateArea(length, width) {
  // Your code here
  return length * width >= 0 ? length * width : NaN;
}
